...
class="flex justify-between m-6 text-lg gap-7 max-sm:text-base max-sm:m-1 max-sm:gap-3">
...
<motion.div ref={ref}
    ...
    variants={{
      visible: { opacity: 1, y: 0 }
    }} class="bg-[#eceff1] dark:bg-[#161616cf] w-[60%] max-md:w-[90%] max-sm:w-[98%] rounded-lg ">
